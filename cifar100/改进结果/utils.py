        ...
        for i, dimen in enumerate(particle_a):
            ...
            if 0 <= dimen <= 15:
                ...
                if conv_name not in conv_name_list:
                    ...
                    conv = '%s = BasicBlock(in_planes=%d, planes=%d, kernel_size=%d, act_func="%s", drop_connect_rate=%.1f)' % (conv_name, in_channel, out_channel, kernel_sizes[num_pool],act_funcs[num_pool],drop_rates[num_pool])
